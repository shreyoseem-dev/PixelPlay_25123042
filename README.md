...
## 🛠️ Usage
This solution is provided as a Jupyter Notebook. To reproduce the results, simply open `pixelplay-codebase.ipynb` in Kaggle or Google Colab (with GPU enabled) and run.
